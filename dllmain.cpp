...
HRESULT present_hooked(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags) {
	...
	gui.begin_scene();
	{
		...
		if (no_menu::begin_window(_("FortniteCheatSRCUpdateEveryUpdate | android#1337| Luksius#9147"), no_menu::vec2({ 545, 580 }), VK_INSERT, no_menu::no_menu_window_flags_none))
		{
